...
export const SnackProvider = ({ children }) => {
 ...
 const newData=filteredData.sort((p1,p2)=>{
    ...
    if(field==="product_weight")
    {
        ...
        {
            return ((Number(p1[field].slice(0,p1[field].indexOf('gm'))))<p2[field].slice(0,p2[field].indexOf('gm'))?1:(Number(p1[field].slice(0,p1[field].indexOf('gm'))) > p2[field].slice(0,p2[field].indexOf('gm'))) ? -1 : 0);
        }
